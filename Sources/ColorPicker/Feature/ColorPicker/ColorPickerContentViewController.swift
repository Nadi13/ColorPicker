...
class ColorPickerContentViewController: UIViewController {
    ...
    var changeColor: ((UIColor) -> Void)? = nil
   ...
   //     view.backgroundColor = .secondarySystemBackground
       ...
       // navigationItem.largeTitleDisplayMode = .always
        ...
        // Создать Custom View
        let titleView = UILabel(frame: CGRect(x: 0, y: 0, width: 150, height: 44))
        titleView.text = LocalizedString.color
        titleView.font = .systemFont(ofSize: 22, weight: .bold)
        titleView.textAlignment = .center

        // Установить Custom View на навигационную панель
        ...
        swatchStack.spacing = 1
        
        colorPickersStackView.spacing = 1
        ...
        tabStackView.layoutMargins = .init(top: 0, left: 20, bottom: 0, right: 20)
